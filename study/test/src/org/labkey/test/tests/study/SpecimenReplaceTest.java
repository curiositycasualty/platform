...
public class SpecimenReplaceTest extends SpecimenMergeTest
{
    ...
    {
        SpecimenImporter importer = new SpecimenImporter(new File[] {LAB15_SPECIMENS}, FOLDER_NAME, ++pipelineJobCount);
    ...
    {
        SpecimenImporter importer = new SpecimenImporter(new File[] {LAB_EDITED_SPECIMENS}, FOLDER_NAME, ++pipelineJobCount);
        importer.setExpectError(true);
        importer.importAndWaitForComplete();
        //go to individual vial list
        goToIndividualvialsDRT();
